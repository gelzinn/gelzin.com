...
export default function Home() {
  ...
  return (
    <main
      className="flex flex-col items-center gap-8 justify-center w-full mx-auto lg:gap-0 lg:justify-between px-4 py-20 sm:px-16"
      style={{
        height: screenHeight ? screenHeight > 640 ? screenHeight : 'auto' : '10vh'
      }}
    >
      <div
      ...
      <footer
        className="fixed bottom-8 left-0 right-0 flex h-auto mx-auto w-full max-w-4xl items-center justify-center sm:justify-between p-8 z-10"
      >
        <div
          className="hidden sm:flex items-center justify-center gap-2 pointer-events-none select-none"
        >
          Software Engineer
        </div>
        <div
